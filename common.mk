...
SRCDIR     ?= 
ROOTDIR    ?= ..
ROOTBINDIR ?= ~/github/newton-fractal-cuda/
BINDIR     ?= $(ROOTBINDIR)/
ROOTOBJDIR ?= obj
LIBDIR     := /Developer/GPU\ Computing/C/lib/
COMMONDIR  := /Developer/GPU\ Computing/C/common/
SHAREDDIR  := /Developer/GPU\ Computing/shared/
